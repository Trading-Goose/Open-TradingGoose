...
export interface TradingTabProps {
  ...
  setDefaultMaxPositionSize: (amount: number) => void;
  setDefaultMinPositionSize: (amount: number) => void;
  setTargetStockAllocation: (percent: number) => void;
  setTargetCashAllocation: (percent: number) => void;
  toggleShowKey: (key: string) => void;
  handleSaveTab: (tab: string) => void;
