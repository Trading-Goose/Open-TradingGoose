...
export default function TradingTab({
  ...
  setDefaultMaxPositionSize,
  setDefaultMinPositionSize,
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4 p-4 border rounded-lg bg-card">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label className="text-sm">Minimum Position Size: {defaultMinPositionSize}%</Label>
                <div className="flex items-center space-x-4">
                  <Slider
                    value={[defaultMinPositionSize]}
                    onValueChange={(value) => setDefaultMinPositionSize(value[0])}
                    min={0.5}
                    max={10}
                    step={0.5}
                    className="flex-1"
                  />
                  <span className="w-12 text-center text-sm font-medium">{defaultMinPositionSize}%</span>
                </div>
                <p className="text-xs text-muted-foreground">
                  Minimum position size as percentage of portfolio value
                </p>
              </div>
              
              <div className="space-y-2">
                <Label className="text-sm">Maximum Position Size: {defaultMaxPositionSize}%</Label>
                <div className="flex items-center space-x-4">
                  <Slider
                    value={[defaultMaxPositionSize]}
                    onValueChange={(value) => setDefaultMaxPositionSize(value[0])}
                    min={5}
                    max={50}
                    step={1}
                    className="flex-1"
                  />
                  <span className="w-12 text-center text-sm font-medium">{defaultMaxPositionSize}%</span>
                </div>
                <p className="text-xs text-muted-foreground">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label className="text-sm flex items-center justify-between">
                    ...
                    <span className="font-semibold text-primary">{targetStockAllocation}%</span>
                  </Label>
                  <Slider
                ...
                <div className="space-y-2">
                  <Label className="text-sm flex items-center justify-between">
                    ...
                    <span className="font-semibold text-muted-foreground">{targetCashAllocation}%</span>
                  </Label>
              ...
              <div className="flex items-center gap-2 p-2 bg-muted/50 rounded-md">
                ...
                <p className="text-xs text-muted-foreground">
                  Target allocation between stocks and cash in your portfolio. Adjust the stock allocation slider to automatically set cash allocation (must total 100%).
                </p>
              </div>
            </div>
          </div>
